...
- Header navigation uses Acadia's no-capsule treatment: transparent nav group, 8px active/hover targets, visible focus, and `aria-current="page"` on the active page.
